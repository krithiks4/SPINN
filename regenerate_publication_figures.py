"""
High-Quality Figure Generation for Paper Revision
Regenerates all figures at publication quality (300 DPI, large fonts)
Addresses Reviewer 1 comments about figure quality
"""
...
def create_training_curves_staged(history_file, output_file):
    """
    Create Figure 3: Training curves separated into stages
    Addresses Reviewer 1 comment about separating loss curves
    """
    ...
    # Highlight stages with background colors
    for stage in stages:
    ...
    # Stage-specific subplots
    for i, stage in enumerate(stages[:3]):  # Show first 3 stages
...
def create_prediction_scatter(predictions_file, output_file):
    """Create high-quality prediction scatter plots"""
...
def create_pruning_progression(pruning_results_file, output_file):
    """Create pruning progression visualization"""
    ...
    # Plot 3: Parameter Reduction Percentage
    ax = axes[1, 0]
...
def create_architecture_diagram(output_file):
    """Create high-quality architecture diagram"""
    ...
    for i in range(len(layers) - 1):
        ...
        # Multiple lines for visual effect
...
def regenerate_all_figures():
    """Regenerate all paper figures at publication quality"""
    ...
    # Figure 2: Training curves (staged) - addresses Reviewer 1 comment
    history_files = [
